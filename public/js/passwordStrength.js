(function (doc) {
    var passwordInput = doc.getElementById("passe2"),
    ...
    hsimp.setDictionary({
        "instantly": "Ce mot de passe peut-être piraté de façon instantanée, changez-le !",
        "forever": "Il faudra un temps infini pour pirater ce mot de passe, Bravo !",
    });
